...
int main (void){
    ...
    printf("You have a %d, in the class. That means you have a %c", grade, letter_grade);


    return 0;
}
//What is the main difference between declaring variables in Python and C? - all variables take the same amount of space, Intergers take up 4 bytes of space and a character takes up 1 byte

//In C, what is the purpose of specifying a data type when declaring a variable? - the amount of bytes you can have in a line 
